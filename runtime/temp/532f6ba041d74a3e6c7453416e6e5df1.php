    ...
    layui.use(['layer','table','form'],function () {
        ...
        table.on('toolbar(test)', function(obj){
            ...
            switch(obj.event){
                ...
                case 'isAll':
                    ...
                    break;
                case 'add':
                    window.location.href="<?php echo url('addcontenthtml'); ?>";
                    break;
            };
        });
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                window.location.href="<?php echo url('upcontenthtml'); ?>?id="+data.id
            }
        });
    });
</script>
