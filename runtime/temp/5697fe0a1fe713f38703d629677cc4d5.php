<?php /*a:7:{s:65:"D:\phpStudy\WWW\blog\application\admin\view\role\addrolehtml.html";i:1536581018;s:60:"D:\phpStudy\WWW\blog\application\admin\view\base\common.html";i:1531213751;s:60:"D:\phpStudy\WWW\blog\application\admin\view\public\head.html";i:1536308456;s:62:"D:\phpStudy\WWW\blog\application\admin\view\public\header.html";i:1536634034;s:60:"D:\phpStudy\WWW\blog\application\admin\view\public\side.html";i:1531469330;s:62:"D:\phpStudy\WWW\blog\application\admin\view\public\footer.html";i:1536308591;s:59:"D:\phpStudy\WWW\blog\application\admin\view\public\var.html";i:1531213677;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <?php if(!(empty($role['ruleid']) || (($role['ruleid'] instanceof \think\Collection || $role['ruleid'] instanceof \think\Paginator ) && $role['ruleid']->isEmpty()))): if(is_array($rule) || $rule instanceof \think\Collection || $rule instanceof \think\Paginator): $key = 0; $__LIST__ = $rule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;if(in_array(($vo['id']), is_array($role['ruleid']??'')?$role['ruleid']??'':explode(',',$role['ruleid']??''))): ?>
                    ...
                    <?php endif; endforeach; endif; else: echo "" ;endif; else: if(is_array($rule) || $rule instanceof \think\Collection || $rule instanceof \think\Paginator): $key = 0; $__LIST__ = $rule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
                    <input type="checkbox" name="ruleid[]" lay-skin="primary" title="<?php echo htmlentities($vo['name']); ?>" value="<?php echo htmlentities($vo['id']); ?>">
