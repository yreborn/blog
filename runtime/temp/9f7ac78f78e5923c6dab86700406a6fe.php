<?php /*a:7:{s:88:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\articleclass\addarticlehtml.html";i:1536566318;s:72:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\base\common.html";i:1531213751;s:72:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\head.html";i:1536308456;s:74:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\header.html";i:1544347311;s:72:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\side.html";i:1531469330;s:74:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\footer.html";i:1536308591;s:71:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\var.html";i:1531213677;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="classname" lay-verify="text|required" autocomplete="off" placeholder="标题" class="layui-input" value="<?php echo isset($article['classname']) ? htmlentities($article['classname']) : ''; ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
                <input type="hidden" name="id" value="<?php echo isset($article['id']) ? htmlentities($article['id']) : ''; ?>">
    ...
    <script>
        layui.use(['form', 'laydate'], function() {
            ...
            form.on('submit(demo1)', function (data) {
                ...
                var url = id ? "<?php echo url('upArticle'); ?>" : "<?php echo url('addarticle'); ?>";
                $.ajax({
                    url: url,
                    data: data.field,
                    type: 'POST',
