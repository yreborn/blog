<?php /*a:7:{s:71:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\role\index.html";i:1536582991;s:72:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\base\common.html";i:1531213751;s:72:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\head.html";i:1536308456;s:74:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\header.html";i:1544347311;s:72:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\side.html";i:1531469330;s:74:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\footer.html";i:1536308591;s:71:"D:\PhpStudy\PHPTutorial\WWW\blog\application\admin\view\public\var.html";i:1531213677;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    layui.use(['layer','table','form'],function () {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'ruleid', title:'权限列表', width:150,templet: function(res){
                    var d = res.getRule;
                    return d && (d.name)?'<em>' + d.name + '</em>': '<em></em>';
                }}
        ...
        table.on('toolbar(test)', function(obj){
            ...
            switch(obj.event){
                ...
                case 'isAll':
                    ...
                    break;
                case 'add':
                    window.location.href="<?php echo url('addrolehtml'); ?>";
                    break;
            };
        });
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                window.location.href="<?php echo url('uprolehtml'); ?>?id="+data.id
            }
        });
    });
</script>
